...
type Address struct {
	...
	ProfileId     int64     `orm:"column(profile_id);null"`
	Attn          string    `orm:"column(attn);null"`
	AddressLine1  string    `orm:"column(address_line1);null"`
	AddressLine2  string    `orm:"column(address_line2);null"`
	City          string    `orm:"column(city);null"`
	StateProvince string    `orm:"column(state_province);null"`
	PostalCode    string    `orm:"column(postal_code);null"`
	Phone         string    `orm:"column(phone);null"`
	Country       string    `orm:"column(country);null"`
	AddressType   int       `orm:"column(address_type);null"`
}
